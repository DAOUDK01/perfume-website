...
export default function AboutPage() {
  ...
  useEffect(() => {
    async function fetchContent() {
      try {
        const result = await fetchJSON<{ content: ContentItem[] }>(
          "/api/admin/content",
          {
            timeout: 8000,
            retries: 2,
        ...
        if (result.success) {
          setContent(
            result.data.content.filter(
              (item: ContentItem) => item.page === "About",
            ) || [],
          );
        } else {
        ...
        <ScrollReveal className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-500  font-light leading-relaxed max-w-2xl mx-auto">
            {getContent(
              ...
              "Description",
              "text",
              "We believe in quiet luxury, thoughtful design, and timeless fragrance. Learn how e'eora came to be.",
            )}
          </p>
        </ScrollReveal>
      </section>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-sm border border-gray-100  bg-gray-50  group aspect-[4/5]">
                ...
                <Image
                  ...
                  alt={getContent(
                    ...
                    "Image Alt Text",
                    "text",
                    "Perfume bottles on a minimalist setting",
                  )}
                  fill
                  objectFit="cover"
                ...
                <div className="space-y-6 text-lg text-gray-600  font-light leading-relaxed">
                  <p>
                    {getContent(
                      ...
                      "Paragraph 1",
                      "text",
                      "e'eora began with a simple belief: that true elegance requires restraint. In a world of excess, we chose simplicity. In a culture of noise, we chose quiet.",
                    )}
                  </p>
                  <p>
                    {getContent(
            ...
            {[
              {
                ...
                desc: getContent(
                  ...
                  "Card 1 Description",
                  "text",
                  "Meticulous attention to every detail. We work with master perfumers to create fragrances that last.",
                ),
              },
              {
                icon: Feather,
                ...
                desc: getContent(
                  ...
                  "Card 2 Description",
                  "text",
                  "Less is more. Our designs are clean and timeless. We believe elegance speaks loudly in silence.",
                ),
              },
              {
                icon: Heart,
                ...
                desc: getContent(
                  ...
                  "Card 3 Description",
                  "text",
                  "No shortcuts. No unnecessary additives. Just pure, concentrated fragrance that tells a story.",
                ),
              },
            ].map((value, index) => (
              <ScrollReveal
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-500 ">
                          {getContent(
                            ...
                            "text",
                            "Ingredients sourced with respect for nature and communities.",
                          )}
                        </p>
                      </div>
                    </div>
              ...
              <div className="relative rounded-2xl overflow-hidden shadow-sm border border-gray-100  bg-gray-50  group aspect-[4/5]">
                ...
                <Image
                  ...
                  alt={getContent(
                    ...
                    "Image Alt Text",
                    "text",
                    "Close up of a perfume bottle and ingredients",
                  )}
                  fill
                  objectFit="cover"
                  className="transition-transform duration-1000 ease-out group-hover:scale-110"
