...
export default function AboutPage() {
  ...
  return (
    <div className="bg-[#fafafa] dark:bg-gray-900">
      {/* Hero Section */}
      <section className="relative pt-40 pb-32 overflow-hidden bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800">
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_var(--tw-gradient-stops))] from-gray-50 via-white to-white dark:from-gray-800 dark:via-gray-900 dark:to-gray-900 opacity-60" />
        <ScrollReveal className="relative z-10 max-w-4xl mx-auto px-6 text-center">
          ...
          <h1 className="text-5xl sm:text-7xl md:text-8xl font-agrandir font-bold text-gray-900 dark:text-gray-100 mb-8 tracking-tight leading-tight">
            {getContent(content, "Hero", "Title", "text", "Our Story")}
          </h1>
          <p className="text-xl md:text-2xl text-gray-500 dark:text-gray-300 font-light leading-relaxed max-w-2xl mx-auto">
      ...
      {/* Our Story Section */}
      <section className="py-24 md:py-32 bg-white dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-center">
            <ScrollReveal>
              <div className="relative rounded-2xl overflow-hidden shadow-sm border border-gray-100 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 group aspect-[4/5]">
            ...
            <ScrollReveal delay={100}>
              <div className="pl-0 md:pl-10">
                ...
                <h2 className="text-4xl md:text-5xl font-serif font-light mb-8 text-gray-900 dark:text-gray-100 leading-tight">
      ...
      {/* Values Section */}
      <section className="py-32 bg-[#fafafa] dark:bg-gray-900 border-b border-gray-100 dark:border-gray-800">
        <div className="max-w-7xl mx-auto px-6">
          <ScrollReveal className="text-center mb-20">
            <span className="text-xs tracking-[0.3em] uppercase text-gray-400 dark:text-gray-500 font-medium mb-4 block">
              {getContent(content, "Values", "Subtitle", "text", "What We Stand For")}
            </span>
            <h2 className="text-4xl md:text-5xl font-serif font-light text-gray-900 dark:text-gray-100">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              <ScrollReveal 
                key={index} 
                delay={index * 100} 
                className="group relative bg-white dark:bg-gray-900 p-10 rounded-2xl border border-gray-100 dark:border-gray-700 shadow-sm hover:shadow-xl hover:-translate-y-2 transition-all duration-500"
              >
                <div className="absolute top-0 right-0 w-24 h-24 bg-gray-50 dark:bg-gray-800 rounded-bl-full -mr-4 -mt-4 opacity-50 transition-all duration-500 group-hover:scale-150 group-hover:bg-gray-100 dark:group-hover:bg-gray-700" />
                <div className="relative z-10">
                  <div className="w-14 h-14 bg-gray-50 dark:bg-gray-800 rounded-2xl flex items-center justify-center mb-8 text-gray-900 dark:text-gray-100 group-hover:bg-black group-hover:text-white dark:group-hover:bg-white dark:group-hover:text-black transition-colors duration-500">
                    <value.icon className="w-7 h-7" strokeWidth={1.5} />
                  </div>
                  <h3 className="text-2xl font-serif font-light mb-4 text-gray-900 dark:text-gray-100">{value.title}</h3>
                  <p className="text-gray-500 dark:text-gray-300 font-light leading-relaxed">{value.desc}</p>
                </div>
              </ScrollReveal>
            ))}
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 md:gap-24 items-center">
            <ScrollReveal className="order-2 md:order-1">
              <div className="pr-0 md:pr-10">
                ...
                <h2 className="text-4xl md:text-5xl font-serif font-light mb-8 text-gray-900 dark:text-gray-100">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-4">
                    <div className="flex items-start gap-4">
                      <div className="p-2 bg-gray-100 dark:bg-gray-800 rounded-full">
                        <Leaf className="w-5 h-5 text-gray-700 dark:text-gray-200" strokeWidth={1.5} />
                      </div>
                      <div>
                    ...
                    <div className="flex items-start gap-4">
                      <div className="p-2 bg-gray-100 dark:bg-gray-800 rounded-full">
                        <Droplets className="w-5 h-5 text-gray-700 dark:text-gray-200" strokeWidth={1.5} />
                      </div>
                      <div>
                        <h4 className="font-medium text-gray-900 dark:text-gray-100 mb-1">
      ...
      <section className="relative py-32 bg-gray-900 overflow-hidden">
        ...
        <ScrollReveal className="relative z-10 max-w-3xl mx-auto px-6 text-center text-white">
          ...
          <Link href="/fragrances">
            <Button variant="primary" className="bg-white text-black hover:bg-gray-200 border-white dark:bg-gray-900 dark:text-white dark:hover:bg-gray-800 dark:border-gray-700">
