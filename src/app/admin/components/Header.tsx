...
export default function Header({
  ...
  return (
    <header className="sticky top-0 z-40 bg-white text-gray-900 shadow-lg border-b border-gray-200 px-6 lg:px-8 py-4">
        ...
        <div className="flex-1 max-w-md mx-8 hidden md:flex">
          <div className="relative w-full">
            ...
            <input
              ...
              className="w-full pl-12 pr-4 py-3 border border-gray-300 bg-gray-100 text-gray-900 rounded-xl focus:outline-none focus:ring-2 focus:ring-gray-300"
            />
          </div>
        </div>
