...
function FragranceCard({
  ...
  return (
    <article className="group flex flex-col bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm rounded-2xl border border-gray-100 dark:border-gray-700 overflow-hidden shadow-sm hover:shadow-lg transition-all duration-300 hover:scale-[1.02]">
      <Link href={`/product/${fragrance.id}`} className="flex flex-col flex-1 relative overflow-hidden">
        ...
        <div className="p-5 md:p-6 flex flex-1 flex-col text-center relative">
          ...
          <div className="relative z-10">
            <h3 className="text-lg md:text-xl font-serif font-light tracking-wide text-gray-900 dark:text-gray-100 transition-colors duration-300">
              {fragrance.name}
            </h3>
            <p className="mt-3 text-sm text-gray-500 dark:text-gray-400 leading-relaxed line-clamp-2 font-light">
              ...
              <button
                ...
                className={`w-full max-w-[220px] py-3 px-6 text-xs tracking-[0.2em] uppercase rounded-full transition-all duration-300 ${
                  inCart > 0 
                    ...
                    : "bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm text-black dark:text-white border border-gray-200 dark:border-gray-600 hover:border-black dark:hover:border-white hover:bg-black dark:hover:bg-white hover:text-white dark:hover:text-black shadow-sm"
                }`}
              >
